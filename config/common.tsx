...
export const config: AppConfig = {
  ...
  icon: BotIcon,
  inviteUrl:
    'https://discord.com/api/oauth2/authorize?client_id=1324492459602088068&permissions=8&scope=bot&response_type=code&redirect_uri=http://localhost:3000/api/auth/callback',
  guild: {
